...
public class AtTargetAtWithinTest {
    ...
    static class Parent {
        public void parentMethod(){} //부모 메서드
    }
    @ClassAop
    static class Child extends Parent{
        public void childMethod(){} //자식 메서드
    }

    @Aspect
    static class AtTargetAtWithinAspect {

        //@target: 인스턴스 기준으로 모든 메서드의 조인 포인트로 선정 (부모 메서드도 적용)
        ...
        //@within: 선택된 클래스 내부의 메소드만 조인 포인트로 선정 (부모 메서드는 제외)
